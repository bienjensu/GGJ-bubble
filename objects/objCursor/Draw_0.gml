...
{
    var lineTargetX = grabbedBubble.x + lengthdir_x(point_distance(grabbedBubble.x,grabbedBubble.y,birdIdealX, birdIdealY)*2,point_direction(grabbedBubble.x,grabbedBubble.y,birdIdealX,birdIdealY)+180)
    var lineTargetY = grabbedBubble.y + lengthdir_y(point_distance(grabbedBubble.x,grabbedBubble.y,birdIdealX, birdIdealY)*2,point_direction(grabbedBubble.x,grabbedBubble.y,birdIdealX,birdIdealY)+180)
